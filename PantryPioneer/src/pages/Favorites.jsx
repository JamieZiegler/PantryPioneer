            ...
            {!user ? (
                ...
                <>
                    <div className="mb-4 rounded-lg border border-border bg-surface p-4 shadow-sm">
                        <label htmlFor="favorites-search" className="sr-only">Search favorites</label>
                        <input
                            id="favorites-search"
                            type="search"
                            value={searchQuery}
                            ...
                            className="w-full rounded-sm border-[1.5px] border-border bg-surface px-4 py-3 text-[0.95rem] text-text-main outline-none transition-[border-color,box-shadow] duration-200 placeholder:text-text-muted hover:border-primary-light focus:border-primary focus:ring-[3px] focus:ring-primary/15"
                        />
                    </div>
